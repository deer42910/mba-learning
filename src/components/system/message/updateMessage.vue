...
export default {
    ...
    return {
      ...
      rules: {
        answer: [
          ...
          { min: 1, max: 500, message: '回复长度在 1 到 500 个字符之间', trigger: 'blur' },
        ],
      },
      loading: false,
      style: {
  ...
  methods: {
    ...
    handleClose() {
      ...
      this.form = { id: '', userId: '', userName: '', content: '', answer: '' }
