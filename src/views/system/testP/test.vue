<template>
  <div class="_test">
    <div class="search-table">
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column prop="totalTime" label="考试时长" width="100" />
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              ...
              <el-button
                size="mini"
                type="warning"
                @click="toTestStudent(scope.row.id)"
                class="custom-button"
              >
                阅卷
              </el-button>
    ...
    <add @addFalse="addFalse" flag="1" :addVisible="addVisible" />
    <update @updateFalse="updateFalse" flag="1" :updateId="updateId" :updateVisible="updateVisible" />
  </div>
</template>
