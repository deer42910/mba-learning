    ...
    <div class="search-table">
      ...
      <div class="search">
        <el-row :gutter="20" style="padding: 15px">
          ...
          <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6" style="display: flex; align-items: center">
            <el-button
              type="primary"
              size="small"
              icon="el-icon-search"
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column prop="intro" label="介绍" min-width="200">
            <template slot-scope="scope">
              <span class="description-text">{{ scope.row.intro || '暂无介绍' }}</span>
            </template>
          </el-table-column>
